...
사번을 입력받아서(파라미터) 
해당 사원의 이름을 반환하는 함수 getEmpName 생성
...
SELECT names.getdeptname(deptno) FROM dept;
...
감지시 실행 로직 : 변경전 pass값을 users_history 에 저장
